...
def invert(fx):
    ...
    util_phase = pdlb.load_plugin("dataset_construction/MixR/plugins/MUtility.vst3")
...
def saturator(fx):
    ...
    saturator = pdlb.load_plugin("dataset_construction/MixR/plugins/MSaturator.vst3")
...
def tremolo(fx):
    ...
    trem = pdlb.load_plugin("dataset_construction/MixR/plugins/MTremolo.vst3")
...
def autopan(fx):
    ...
    autopan = pdlb.load_plugin("dataset_construction/MixR/plugins/MAutopan.vst3")
...
def vibrato(fx):
    ...
    vibrato = pdlb.load_plugin("dataset_construction/MixR/plugins/MVibrato.vst3")
...
def pan(fx):
    ...
    util_pan = pdlb.load_plugin("dataset_construction/MixR/plugins/MUtility.vst3")
...
fx_map = read_csv_to_adjacency_list("dataset_construction/MixR/data/fx.csv")
